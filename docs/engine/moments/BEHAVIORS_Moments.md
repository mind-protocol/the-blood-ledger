# Moments — Behaviors: What Should Happen
...
THIS:        BEHAVIORS_Moments.md (you are here)
ALGORITHMS:
...
- Time passing injects energy (importance × proximity)
- Important characters accumulate energy
...
| Tension boils | Tension node weight > 0.9 |
