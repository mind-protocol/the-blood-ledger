...
nodes:
  ...
  character:
    ...
    attributes:
      ...
      image_prompt:
        type: string
        description: "Read docs/image-generation/PATTERNS_Image_Generation.md before writing. Prompt for character portrait — face, clothing, posture, lighting, mood."
  ...
  place:
    ...
    attributes:
      ...
      image_prompt:
        type: string
        description: "Read docs/image-generation/PATTERNS_Image_Generation.md before writing. Prompt for place illustration — architecture, weather, time, atmosphere."
  ...
  thing:
    ...
    attributes:
      ...
      image_prompt:
        type: string
        description: "Read docs/image-generation/PATTERNS_Image_Generation.md before writing. Prompt for thing illustration — material, craftsmanship, condition, lighting, context."
