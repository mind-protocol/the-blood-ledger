...
This file defines the health checks and verification mechanics for the `engine/models/` module. It ensures the integrity and consistency of the game's data schema, protecting against type mismatches, missing required fields, and incorrect value ranges.
...
docks:
  input:
    ...
    location: engine/models/nodes.py:53
  output:
