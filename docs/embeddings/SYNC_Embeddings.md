...
- **What:** Created docs/embeddings/ with full PATTERN → TEST chain
- **Why:** New embedding spec introduces universal `detail` field approach
- **Files:**
  - docs/embeddings/PATTERNS_Embeddings.md
  - docs/embeddings/BEHAVIORS_Embeddings.md
  - docs/embeddings/ALGORITHM_Embeddings.md
  - docs/embeddings/VALIDATION_Embeddings.md
  - docs/embeddings/TEST_Embeddings.md
  - docs/embeddings/SYNC_Embeddings.md
...
**Decisions made:**
- New subfolder docs/embeddings/ (distinct module)
