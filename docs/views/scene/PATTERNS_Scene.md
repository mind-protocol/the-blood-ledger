...
STATUS: DESIGNING
LINKS_TO:
  - docs/vision/BEHAVIORS_Vision.md (key experience moments)
  - docs/vision/ALGORITHM_Vision.md (scene creation system)
```
...
- Vision: `docs/vision/BEHAVIORS_Vision.md` (key experience moments)
- System: `docs/vision/ALGORITHM_Vision.md` (scene creation in systems list)
