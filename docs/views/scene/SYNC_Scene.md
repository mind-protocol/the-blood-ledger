...
| Data contract | Specced | Engine | `/api/view` definition lives in docs/engine/moments/API_Moments.md |
...
2. **Frontend stub** hitting mocked `/api/view` data (use `docs/engine/moments/API_Moments.md` example).
...
- Moment graph implementation (docs/engine/moments/SYNC_Moments.md)
