...
CREATED: 2024-12-16
STATUS: Canonical
UPDATED: 2025-12-20 (consolidated into overview)
```
...
RENDERING:       ../rendering/ALGORITHM_Rendering_Pipeline.md
PLACES:          ../places/ALGORITHM_Places.md
...
See `docs/world/map/ALGORITHM_Map.md` for the consolidated Routes algorithm.
