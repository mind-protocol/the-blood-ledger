...
THIS:           IMPLEMENTATION_Billing.md
...
|------|---------|----------------------|-------|--------|
| data/Distributed-Content-Generation-Network/Blood Ledger — Billing Architecture.md | Source spec for this module | N/A | N/A | DRAFT |
...
|----------|--------|---------|-----------|
| Billing | Design docs | Runtime code | N/A |
