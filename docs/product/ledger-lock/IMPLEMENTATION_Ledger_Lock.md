...
THIS:           IMPLEMENTATION_Ledger_Lock.md
...
|------|---------|----------------------|-------|--------|
| data/Distributed-Content-Generation-Network/UX Design The Ledger Lock.md | Source spec for this module | N/A | N/A | DRAFT |
...
|----------|--------|---------|-----------|
| Ledger Lock | Design docs | Runtime code | N/A |
