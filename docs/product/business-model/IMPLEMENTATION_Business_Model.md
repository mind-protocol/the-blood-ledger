...
THIS:           IMPLEMENTATION_Business_Model.md
...
|------|---------|----------------------|-------|--------|
| data/Distributed-Content-Generation-Network/Blood Ledger — Business Model Stress Test.md | Source spec for this module | N/A | N/A | DRAFT |
...
|----------|--------|---------|-----------|
| Business Model | Design docs | Runtime code | N/A |
