...
**FIRST:** Read `docs/opening/GUIDE.md` before starting the opening. It contains the payoff structure, tone matching rules, and examples.
...
**Payoff structure** (see `docs/opening/GUIDE.md` for full details):
...
- `docs/opening/opening.json` — The 17 questions
- `docs/opening/GUIDE.md` — Payoff structure (seeing → path → build → validation)
