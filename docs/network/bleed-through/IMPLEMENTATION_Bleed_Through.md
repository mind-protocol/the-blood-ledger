...
THIS:           IMPLEMENTATION_Bleed_Through.md
...
|------|---------|----------------------|-------|--------|
| data/Distributed-Content-Generation-Network/Blood Ledger — The Bleed-Through.md | Source spec for this module | N/A | N/A | DRAFT |
...
|----------|--------|---------|-----------|
| Bleed-Through | Design docs | Runtime code | N/A |
