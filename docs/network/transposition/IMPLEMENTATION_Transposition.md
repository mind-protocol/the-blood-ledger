...
THIS:           IMPLEMENTATION_Transposition.md
...
|------|---------|----------------------|-------|--------|
| data/Distributed-Content-Generation-Network/ALGORITHM Character & Narrative Transposition Logic.md | Source spec for this module | N/A | N/A | DRAFT |
...
|----------|--------|---------|-----------|
| Transposition | Design docs | Runtime code | N/A |
