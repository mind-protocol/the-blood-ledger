...
**Target:** `docs/product/business-model/BEHAVIORS_Retention_Mechanisms.md`
**Problem:** Multiple BEHAVIORS docs in `business-model/`
**Details:** {'doc_type': 'BEHAVIORS', 'folder': 'business-model', 'docs': ['docs/product/business-model/BEHAVIORS_Retention_Mechanisms.md', 'docs/product/business-model/BEHAVIORS_Unit_Economics.md', 'docs/product/business-model/BEHAVIORS_Conversion_Funnel_And_Ledger_Lock.md']}
...
- docs/product/business-model/BEHAVIORS_Retention_Mechanisms.md
