...
**Target:** `docs/product/chronicle-system/PATTERNS_Chronicle_Flywheel.md`
**Problem:** Multiple PATTERNS docs in `chronicle-system/`
**Details:** {'doc_type': 'PATTERNS', 'folder': 'chronicle-system', 'docs': ['docs/product/chronicle-system/PATTERNS_Chronicle_Flywheel.md', 'docs/product/chronicle-system/PATTERNS_Chronicle_GTM_Integration.md']}
