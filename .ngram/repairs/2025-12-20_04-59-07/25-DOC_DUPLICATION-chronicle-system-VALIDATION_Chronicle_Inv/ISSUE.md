...
**Target:** `docs/product/chronicle-system/VALIDATION_Chronicle_Invariants.md`
**Problem:** Multiple VALIDATION docs in `chronicle-system/`
**Details:** {'doc_type': 'VALIDATION', 'folder': 'chronicle-system', 'docs': ['docs/product/chronicle-system/VALIDATION_Chronicle_Invariants.md', 'docs/product/chronicle-system/VALIDATION_Chronicle_Metrics_And_Success.md']}
...
- docs/product/chronicle-system/VALIDATION_Chronicle_Invariants.md
