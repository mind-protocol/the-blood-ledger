...
**Target:** `docs/product/chronicle-system/BEHAVIORS_Chronicle_Types.md`
**Problem:** Multiple BEHAVIORS docs in `chronicle-system/`
**Details:** {'doc_type': 'BEHAVIORS', 'folder': 'chronicle-system', 'docs': ['docs/product/chronicle-system/BEHAVIORS_Chronicle_Types.md', 'docs/product/chronicle-system/BEHAVIORS_Chronicle_Types_And_Structure.md']}
...
- docs/product/chronicle-system/BEHAVIORS_Chronicle_Types.md
