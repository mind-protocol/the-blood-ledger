...
**Target:** `docs/infrastructure/api/ALGORITHM_Playthrough_Creation.md`
**Problem:** Multiple ALGORITHM docs in `api/`
**Details:** {'doc_type': 'ALGORITHM', 'folder': 'api', 'docs': ['docs/infrastructure/api/ALGORITHM_Playthrough_Creation.md', 'docs/infrastructure/api/ALGORITHM_Api.md']}
