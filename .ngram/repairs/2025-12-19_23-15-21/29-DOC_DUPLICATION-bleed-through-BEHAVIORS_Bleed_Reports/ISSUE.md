...
**Target:** `docs/network/bleed-through/BEHAVIORS_Bleed_Reports.md`
**Problem:** Multiple BEHAVIORS docs in `bleed-through/`
**Details:** {'doc_type': 'BEHAVIORS', 'folder': 'bleed-through', 'docs': ['docs/network/bleed-through/BEHAVIORS_Bleed_Reports.md', 'docs/network/bleed-through/BEHAVIORS_Ghosts_Rumors_Reports.md']}
...
- docs/network/bleed-through/BEHAVIORS_Bleed_Reports.md
