...
- `grep -r "frontend/components/minimap" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/minimap` to understand what it does
