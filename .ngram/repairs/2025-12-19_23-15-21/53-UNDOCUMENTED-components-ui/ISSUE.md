...
- `grep -r "frontend/components/ui" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/ui` to understand what it does
