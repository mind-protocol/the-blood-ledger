...
**Target:** `docs/physics`
**Problem:** Total 264K chars (threshold: 50K)
**File sizes:** [('ALGORITHM_Physics.md', '141K'), ('IMPLEMENTATION_Physics.md', '35K'), ('VALIDATION_Physics.md', '18K'), ('TEST_Physics.md', '18K'), ('BEHAVIORS_Physics.md', '13K')]
...
## Archiving pattern:
- Create `docs/physics/archive/SYNC_archive_2024-12.md` for old content
