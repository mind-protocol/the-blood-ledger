...
**Target:** `docs/product/business-model/PATTERNS_Market_Comparison.md`
**Problem:** Multiple PATTERNS docs in `business-model/`
**Details:** {'doc_type': 'PATTERNS', 'folder': 'business-model', 'docs': ['docs/product/business-model/PATTERNS_Market_Comparison.md', 'docs/product/business-model/PATTERNS_Whale_Economics.md']}
...
- docs/product/business-model/PATTERNS_Market_Comparison.md
