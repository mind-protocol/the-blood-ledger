...
- `grep -r "tests/infrastructure/canon" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `tests/infrastructure/canon` to understand what it does
