...
- `grep -r "frontend/components/map" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/map` to understand what it does
