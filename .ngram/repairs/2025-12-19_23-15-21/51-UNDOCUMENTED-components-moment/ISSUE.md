...
- `grep -r "frontend/components/moment" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/moment` to understand what it does
