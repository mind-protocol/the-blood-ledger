...
- `grep -r "engine/infrastructure/tempo" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/infrastructure/tempo` to understand what it does
