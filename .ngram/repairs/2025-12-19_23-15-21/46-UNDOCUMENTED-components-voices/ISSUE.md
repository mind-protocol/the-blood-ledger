...
- `grep -r "frontend/components/voices" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/voices` to understand what it does
