...
**Target:** `docs/world/map/ALGORITHM_Rendering.md`
**Problem:** Multiple ALGORITHM docs in `map/`
**Details:** {'doc_type': 'ALGORITHM', 'folder': 'map', 'docs': ['docs/world/map/ALGORITHM_Rendering.md', 'docs/world/map/ALGORITHM_Map.md']}
