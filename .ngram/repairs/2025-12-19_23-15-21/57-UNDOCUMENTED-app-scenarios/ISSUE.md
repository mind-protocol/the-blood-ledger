...
- `grep -r "frontend/app/scenarios" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/app/scenarios` to understand what it does
