...
**Target:** `docs/world/scraping`
**Problem:** Total 54K chars (threshold: 50K)
**File sizes:** [('ALGORITHM_Pipeline.md', '14K'), ('SYNC_World_Scraping.md', '13K'), ('IMPLEMENTATION_World_Scraping_Pipeline_Architecture.md', '10K'), ('VALIDATION_World_Scraping.md', '5K'), ('PATTERNS_World_Scraping.md', '4K')]
...
## Archiving pattern:
- Create `docs/world/scraping/archive/SYNC_archive_2024-12.md` for old content
