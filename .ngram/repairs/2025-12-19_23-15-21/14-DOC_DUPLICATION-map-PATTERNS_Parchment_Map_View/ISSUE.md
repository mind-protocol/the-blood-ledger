...
**Target:** `docs/frontend/map/PATTERNS_Parchment_Map_View.md`
**Problem:** Multiple PATTERNS docs in `map/`
**Details:** {'doc_type': 'PATTERNS', 'folder': 'map', 'docs': ['docs/frontend/map/PATTERNS_Parchment_Map_View.md', 'docs/frontend/map/PATTERNS_Interactive_Travel_Map.md', 'docs/world/map/PATTERNS_Map.md']}
