...
**Target:** `engine/tests`
**Problem:** No documentation mapping (14 files)

## CRITICAL: Check for existing docs first

Before creating anything, search for existing documentation:
- `grep -r "engine/tests" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/tests` to understand what it does
