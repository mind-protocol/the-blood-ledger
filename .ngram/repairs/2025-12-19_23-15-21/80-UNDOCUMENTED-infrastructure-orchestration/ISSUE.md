...
- `grep -r "engine/infrastructure/orchestration" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/infrastructure/orchestration` to understand what it does
