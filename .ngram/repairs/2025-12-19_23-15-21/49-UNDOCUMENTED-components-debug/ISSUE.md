...
- `grep -r "frontend/components/debug" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `frontend/components/debug` to understand what it does
