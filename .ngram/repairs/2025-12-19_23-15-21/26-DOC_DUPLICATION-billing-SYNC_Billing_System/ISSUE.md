...
**Target:** `docs/product/billing/SYNC_Billing_System.md`
**Problem:** Multiple SYNC docs in `billing/`
**Details:** {'doc_type': 'SYNC', 'folder': 'billing', 'docs': ['docs/product/billing/SYNC_Billing_System.md', 'docs/product/billing/SYNC_Billing.md']}
...
- docs/product/billing/SYNC_Billing_System.md
