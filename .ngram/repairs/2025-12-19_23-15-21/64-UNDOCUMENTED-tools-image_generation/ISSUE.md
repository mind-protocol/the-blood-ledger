...
- `grep -r "tools/image_generation" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `tools/image_generation` to understand what it does
