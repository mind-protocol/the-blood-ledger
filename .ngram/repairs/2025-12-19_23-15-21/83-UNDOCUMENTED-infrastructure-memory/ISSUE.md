...
- `grep -r "engine/infrastructure/memory" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/infrastructure/memory` to understand what it does
