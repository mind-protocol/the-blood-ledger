...
**Target:** `docs/infrastructure/world-builder/IMPLEMENTATION/IMPLEMENTATION_Overview.md`
**Problem:** References 7 non-existent file(s)
**Missing files:** ['query_moment.py', 'sparsity.py', 'WorldBuilder.enrich', 'world_builder.py', 'query.py', 'archive/SYNC_archive_2024-12.md', 'enrichment.py']
