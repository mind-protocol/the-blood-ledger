...
**Target:** `engine/physics`
**Problem:** No documentation mapping (15 files)

## CRITICAL: Check for existing docs first

Before creating anything, search for existing documentation:
- `grep -r "engine/physics" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/physics` to understand what it does
