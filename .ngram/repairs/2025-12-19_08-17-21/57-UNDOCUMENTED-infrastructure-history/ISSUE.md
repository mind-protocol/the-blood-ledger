...
- `grep -r "engine/infrastructure/history" docs/` - check if this path is mentioned in existing docs
...
4. If not found:
   ...
   b. Read the code in `engine/infrastructure/history` to understand what it does
