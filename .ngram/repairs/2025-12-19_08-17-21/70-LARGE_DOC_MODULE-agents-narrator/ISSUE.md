...
**Severity:** warning
**Target:** docs/agents/narrator

## Instructions
## Task: Reduce Documentation Size

**Target:** `docs/agents/narrator`
**Problem:** Total 102K chars (threshold: 50K)
**File sizes:** [('ALGORITHM_Scene_Generation.md', '27K'), ('TOOL_REFERENCE.md', '12K'), ('IMPLEMENTATION_Narrator.md', '10K'), ('BEHAVIORS_Narrator.md', '8K'), ('TEST_Narrator.md', '8K')]
...
## Archiving pattern:
- Create `docs/agents/narrator/archive/SYNC_archive_2024-12.md` for old content
