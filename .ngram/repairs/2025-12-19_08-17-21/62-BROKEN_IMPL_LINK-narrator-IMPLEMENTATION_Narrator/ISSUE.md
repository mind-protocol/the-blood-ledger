...
**Missing files:** ['engine/infrastructure/orchestration/narrator_prompt.py', 'playthroughs/{id}/current_action.json', 'narrator_prompt.py', 'playthroughs/{id}/PROFILE_NOTES.md', 'stream_dialogue.py', 'narrator.py', 'graph_ops.py']
