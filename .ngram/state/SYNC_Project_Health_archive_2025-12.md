...
- `docs/frontend/IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Runtime_And_Config.md` - References 17 non-existent file(s)
  - Update or remove references: map.ts, layout.tsx, useMoments.ts
- `docs/world/scraping/IMPLEMENTATION_World_Scraping_Pipeline_Architecture.md` - References 7 non-existent file(s)
  - Update or remove references: inject_world.py, phase5_tensions.py, phase4_narratives.py
...
- `docs/design/opening/IMPLEMENTATION_Opening.md` - References 9 non-existent file(s)
  - Update or remove references: playthroughs/{id}/player.yaml, # DOCS: docs/design/opening/IMPLEMENTATION_Opening.md, CONTENT.md
- `docs/infrastructure/embeddings/IMPLEMENTATION_Embeddings.md` - References 3 non-existent file(s)
  - Update or remove references: EmbeddingService.model, service.py, engine/infrastructure/embeddings/service.py
...
- `docs/infrastructure/async/IMPLEMENTATION_Async_Architecture.md` - References 7 non-existent file(s)
  - Update or remove references: agents/world_runner/CLAUDE.md, playthroughs/{playthrough_id}/injection_queue.json, playthroughs/narrator_state.json
...
- `docs/infrastructure/world-builder/IMPLEMENTATION/IMPLEMENTATION_Overview.md` - References 8 non-existent file(s)
  - Update or remove references: world_builder.py, enrichment.py, engine/infrastructure/orchestration/agent_cli.py
- ... and 4 more

### INCOMPLETE_CHAIN (27 files)
...
- `docs/world/map` - Missing: HEALTH
- `docs/world/scraping` - Missing: HEALTH
...
- `docs/infrastructure/canon/IMPLEMENTATION_Canon.md` - Doc filename 'IMPLEMENTATION_Canon.md' is too short/non-descriptive
- `docs/infrastructure/embeddings/ALGORITHM_Embeddings.md` - Doc filename 'ALGORITHM_Embeddings.md' is too short/non-descriptive
- `docs/infrastructure/embeddings/archive/SYNC_archive_2024-12.md` - Naming convention violations task (7): 10 items
- `docs/infrastructure/history/TEST_History.md` - Doc filename 'TEST_History.md' is too short/non-descriptive
- `docs/infrastructure/storms/TEST_Storms.md` - Doc filename 'TEST_Storms.md' is too short/non-descriptive
- `docs/infrastructure/world-builder/BEHAVIORS_World_Builder.md` - Doc filename 'BEHAVIORS_World_Builder.md' is too short/non-descriptive
- ... and 10 more
