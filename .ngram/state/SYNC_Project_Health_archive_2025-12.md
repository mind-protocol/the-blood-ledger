...
- `docs/frontend/IMPLEMENTATION_Frontend_Code_Architecture.md` - References 2 non-existent file(s)
  - Update or remove references: IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Code_Structure.md, IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Runtime_And_Config.md
...
- `docs/frontend/IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Code_Structure.md` - References 16 non-existent file(s)
  - Update or remove references: game-state.json, GameClient.tsx, useGameState.ts
- `docs/agents/narrator/IMPLEMENTATION_Narrator.md` - References 4 non-existent file(s)
  - Update or remove references: TOOL_REFERENCE.md, graph_ops.py, agent_cli.py
...
- `docs/physics/IMPLEMENTATION_Physics.md` - References 3 non-existent file(s)
  - Update or remove references: graph_ops.py, moments.py, engine/physics/graph/graph_ops_*.py
...
- `docs/infrastructure/embeddings/IMPLEMENTATION_Embeddings.md` - References 8 non-existent file(s)
  - Update or remove references: engine/infrastructure/embeddings/service.py:EmbeddingService.embed_batch, engine/infrastructure/embeddings/service.py:EmbeddingService.similarity, engine/infrastructure/embeddings/service.py:EmbeddingService.model
...
- `docs/infrastructure/api/IMPLEMENTATION_Api.md` - References 12 non-existent file(s)
  - Update or remove references: app.py, tempo.py, player.yaml
- ... and 4 more
...
- `docs/physics/IMPLEMENTATION_Physics.md` - 3 referenced files not found
- `docs/infrastructure/api/IMPLEMENTATION_Api.md` - 9 referenced files not found
- `docs/infrastructure/world-builder/IMPLEMENTATION/IMPLEMENTATION_Overview.md` - 6 referenced files not found

### DOC_TEMPLATE_DRIFT (229 files)
...
- `docs/frontend/IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Runtime_And_Config.md` - References 1 non-existent file(s)
  - Update or remove references: useMoments.clickWord
- `docs/frontend/IMPLEMENTATION_Frontend_Code_Architecture/IMPLEMENTATION_Code_Structure.md` - References 16 non-existent file(s)
  - Update or remove references: MomentDisplay.tsx, game.ts, game-state.json
- `docs/agents/narrator/IMPLEMENTATION_Narrator.md` - References 4 non-existent file(s)
  - Update or remove references: graph_ops.py, agent_cli.py, INPUT_REFERENCE.md
- `docs/world/scraping/IMPLEMENTATION_World_Scraping_Pipeline_Architecture.md` - References 1 non-existent file(s)
  - Update or remove references: places.yaml
- `docs/physics/IMPLEMENTATION_Physics.md` - References 11 non-existent file(s)
  - Update or remove references: engine/physics/graph/graph_ops_*.py, engine/infrastructure/orchestration/speed.py, graph_queries_narratives.py
- `docs/product/billing/IMPLEMENTATION_Billing_Technical_Stack.md` - References 1 non-existent file(s)
  - Update or remove references: tick.py
- `docs/infrastructure/embeddings/IMPLEMENTATION_Embeddings.md` - References 8 non-existent file(s)
  - Update or remove references: engine/infrastructure/embeddings/service.py:EmbeddingService.model, engine/infrastructure/embeddings/service.py:EmbeddingService.similarity, engine/infrastructure/embeddings/service.py:EmbeddingService.dimension
- `docs/infrastructure/history/IMPLEMENTATION_History_Service_Architecture.md` - References 1 non-existent file(s)
  - Update or remove references: conversations/aldric.md
- `docs/infrastructure/api/IMPLEMENTATION_Api.md` - References 12 non-existent file(s)
  - Update or remove references: playthroughs.py, python app.py, sse_broadcast.py
- ... and 4 more
...
### NON_STANDARD_DOC_TYPE (37 files)
...
- `docs/agents/world-runner/TOOL_REFERENCE.md` - Doc filename does not use a standard prefix
- `docs/agents/world-runner/INPUT_REFERENCE.md` - Doc filename does not use a standard prefix
- `docs/physics/HEALTH_Physics.md` - Doc filename does not use a standard prefix
- `docs/physics/API_Physics.md` - Doc filename does not use a standard prefix
- ... and 27 more
