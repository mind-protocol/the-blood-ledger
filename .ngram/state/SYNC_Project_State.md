...
Expanded `docs/infrastructure/api/TEST_Api.md` with the missing test template
sections (strategy, unit/integration, edge cases, coverage, run guidance,
...
repair #16. Ran `ngram validate`; remaining failures are pre-existing missing
VIEW and doc-chain gaps in schema/product/network/storms modules.

Verified `docs/design/TEST_Vision.md` already includes the required test
template sections; logged the confirmation in `docs/design/SYNC_Vision.md` for
repair #16 without further content edits.
...
Filled the missing FLAKY TESTS section in
`docs/agents/world-runner/TEST_World_Runner_Coverage.md` and logged the update
in `docs/agents/world-runner/SYNC_World_Runner.md` for repair #16.
